...
def parse_args():
    ...
    base_options.add_argument('-b', '--input-bias-file', dest='biases_path', default="",
                              help="Path to a BIAS file. Ignored if a path to a RAW file is set.")
    ...
    print("Biases path     :" + args.biases_path)
