...
from .event_to_tensor import histo, diff, timesurface, event_cube, multi_channel_timesurface  # pylint:disable-all
...
class CDProcessor(object):
    ...
    def __call__(self, events, delta_t=None):
        delta_t = delta_t if delta_t is not None else events['t'][-1]-events['t'][0]
        self.array[...] = 0
