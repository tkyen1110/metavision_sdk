...
#ifndef METAVISION_SDK_CV_NORMAL_FLOW_ESTIMATOR_H
#define METAVISION_SDK_CV_NORMAL_FLOW_ESTIMATOR_H
...
public:
    ...
    NormalFlowEstimator(int radius = 3, bool enable_flow_normalization = false,
...
#include "metavision/sdk/cv/utils/detail/normal_flow_estimator_impl.h"

#endif // METAVISION_SDK_CV_NORMAL_FLOW_ESTIMATOR_H
