...
#ifndef METAVISION_SDK_CV_NORMAL_FLOW_ESTIMATOR_IMPL_H
#define METAVISION_SDK_CV_NORMAL_FLOW_ESTIMATOR_IMPL_H
...
bool NormalFlowEstimator::get_flow(const MostRecentTimestampBufferT<timestamp> &pxts, int x, int y, real_t &vx,
...
#endif // METAVISION_SDK_CV_NORMAL_FLOW_ESTIMATOR_IMPL_H
